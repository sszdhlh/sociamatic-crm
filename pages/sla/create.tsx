...
export default function CreateSLAPolicy() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    console.log('Submitting SLA policy:', {
      ...formData,
      conditions,
      targets,
    });
  ...
  return (
    <>
      <Head>
        <title>Create SLA Policy | Sociamatic CRM</title>
        <meta name="description" content="Create a new SLA policy" />
      </Head>
      ...
      <div className="py-6">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
          <div className="flex items-center">
            ...
            <h1 className="text-2xl font-semibold text-gray-900">Create SLA Policy</h1>
          </div>
        </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-8 divide-y divide-gray-200 max-w-3xl">
              <div className="space-y-6">
                <div>
                  ...
                  <p className="mt-1 text-sm text-gray-500">Define the basic details of your SLA policy.</p>
                </div>
